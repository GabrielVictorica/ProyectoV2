-- Fix: Exclude cancelled transactions from FINANCIAL metrics in view_agent_progress
-- Activity metrics (weekly_reservas, weekly_green_meetings) are NOT changed —
-- they measure agent activity, not financial results.
